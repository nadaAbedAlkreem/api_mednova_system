<div class="flex-col fixed top-0 bottom-0 z-20 hidden lg:flex items-stretch shrink-0 w-[--tw-sidebar-width] dark" data-drawer="true" data-drawer-class="drawer drawer-start flex top-0 bottom-0" data-drawer-enable="true|lg:false" id="sidebar">
    ...
    <div class="flex items-stretch grow shrink-0 justify-center my-5" id="sidebar_menu">
        <div class="scrollable-y-auto grow" data-scrollable="true" data-scrollable-dependencies="#sidebar_header, #sidebar_footer" data-scrollable-height="auto" data-scrollable-offset="0px" data-scrollable-wrappers="#sidebar_menu">
            <!-- Primary Menu -->
            <div class="mb-5">
                        ...
                        <div class="menu-accordion gap-px ps-7">
                            <div class="menu-item" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100" href="{{route('admin.dashboard.home')}}">
        ...
        <div class="flex items-center gap-1.5">
         ...
         <span class="menu-icon">
          <i class="ki-filled ki-notification-status">
            ...
            <a class="btn btn-icon btn-icon-lg size-8 hover:bg-light hover:text-primary text-gray-600" href="{{route('admin.logout')}}">
