...
<head><base href="../../../../">
    ...
    <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/network/user-table/saas-users" rel="canonical"/>
    ...
    <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/network/user-table/saas-users" property="og:url"/>
...
<div class="flex grow">
    ...
    <div class="sidebar dark:bg-coal-600 bg-light border-r border-r-gray-200 dark:border-r-coal-100 fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0" data-drawer="true" data-drawer-class="drawer drawer-start top-0 bottom-0" data-drawer-enable="true|lg:false" id="sidebar">
        ...
        <div class="sidebar-content flex grow shrink-0 pt-2 lg:pt-0 pe-2" id="sidebar_content">
            <div class="scrollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pr-1 lg:pe-3" data-scrollable="true" data-scrollable-dependencies="#sidebar_header" data-scrollable-height="auto" data-scrollable-offset="0px" data-scrollable-wrappers="#sidebar_content" id="sidebar_scrollable">
                <!-- Sidebar Menu -->
