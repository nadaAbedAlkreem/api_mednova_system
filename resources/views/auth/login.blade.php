...
<div class="flex items-center justify-center grow bg-center bg-no-repeat page-bg">
    <div class="card max-w-[370px] w-full">
        <form class="card-body flex flex-col gap-5 p-10" id="sign_in_form" >
          @csrf
       ...
       Remember me
            ...
            <button type="submit" id="kt_sign_in_submit" class="btn btn-primary flex justify-center grow">
                Sign In
            </button>
        </form>
    </div>
...
<script src="assets/js/authentication/sign-in/login-action.js">
</script>
