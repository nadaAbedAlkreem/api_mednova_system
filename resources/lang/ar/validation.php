...
return [
    ...
    'custom' => [
        ...
        'approval_status' => [
            'required' => 'يرجى اختيار حالة الطلب.',
            'in' => 'حالة الطلب غير صحيحة.',
        ],

        'reason' => [
            'required_if' => 'يرجى إدخال سبب الرفض قبل المتابعة.',
            'max' => 'سبب الرفض يجب ألا يتجاوز :max حرف.',
        ],

        'videos' => [
            'duplicate_order' => 'لا يمكن تكرار ترتيب الفيديو أكثر من مرة.',
            'multiple_intro' => 'يمكن تحديد فيديو مقدمة واحد فقط للبرنامج.',
            'intro_required' => 'يجب تحديد فيديو واحد كمقدمة للبرنامج.',
        ],
    ...
    'attributes' => [
        ...
        'countries_certified' => 'الدولة التي منحت الشهادة',
        'graduation_years' => 'سنوات الخبرة',
        'certificate_file' => 'نسخة من الشهادة',
        ...
        'commercial_registration_authority' => 'جهة السجل التجاري',
        'day_of_week' => 'أيام الدوام',
        'start_time_morning' => 'بداية الدوام الصباحي',
        'end_time_morning' => 'نهاية الدوام الصباحي',
        'start_time_evening' => 'بداية الدوام المسائي',
        'end_time_evening' => 'نهاية الدوام المسائي',
        'is_have_evening_time' => 'يوجد دوام مسائي',
        'type' => 'نوع المركز',
        'is_active' => 'نشط',
        'patient_account' => 'معرف المريض المحدد لا ينتمي إلى حساب مريض.',
        ...
        'status' => 'حالة',
        'action_by' => 'صاحب أجراء إلغاء  طلب الاستشارة',
        'action_reason' => 'سبب إلغاء طلب الاستشارة ',
        'cancelled' => 'ملغي ',
        'title_ar' => 'عنوان',
        ...
        'program_id' => 'برنامج',
        'videos' => 'الفيديوهات',
        'video_title_ar' => 'عنوان الفيديو',
        'video_file' => 'مرفق الفيديو',
        'duration_minute' => 'المدة بالدقيقة',
        'what_you_will_learn_ar' => ' ما ستتعلمه في البرنامج ',
