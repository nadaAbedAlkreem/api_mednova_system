...
return [
    ...
    'UNAUTHORISED_ACCOUNT_TYPE' => 'نوع الحساب غير مصرح له بالوصول',
    ...
    'Subscription_Restrictions' => 'لا يسمح بتعين المستشار على انه مشترك الا بعد اتمام استكمال بياناته و اعتماد حسابه و تحقق من فعالية حسابه',
    'account_successfully_disabled' => ' تم تعطيل الحساب بنجاح   ',
    ...
    'UPDATE_STATUS'=>'تم تحديث عملية بنجاح ',
    'STATUS_UPDATED' => 'تم تحديث العملية بنجاح',
    ...
    'DISPUTE_OPENED_SUCCESSFULLY' => 'تم فتح النزاع بنجاح وسيتم مراجعته من قبل الإدارة.',
    'DISPUTE_RESOLVED_SUCCESSFULLY' => 'تم حل النزاع بنجاح.',
    'DISPUTE_ALREADY_RESOLVED' => 'هذا النزاع محلول بالفعل ولا يمكن معالجته مرة أخرى.',
    'INSUFFICIENT_PLATFORM_FROZEN_BALANCE' => 'الرصيد المجمّد للمنصة غير كافٍ لإتمام العملية.',
    'dispute_resolved_refund_patient' => 'تم حل النزاع لصالحك. تم إرجاع مبلغ :amount :currency إلى رصيدك.',
    'dispute_resolved_refund_consultant' => 'تم حل النزاع على الاستشارة رقم :consultation_id لصالح المريض.',
    'dispute_resolved_release_patient' => 'تم حل النزاع على الاستشارة رقم :consultation_id لصالح المستشار.',
    'dispute_resolved_release_consultant' => 'تم حل النزاع لصالحك. أرباحك :amount :currency أصبحت متاحة للسحب.',
    'INVALID_CONSULTATION_AMOUNT' => 'مبلغ الاستشارة غير صالح.',
    'INSUFFICIENT_PLATFORM_PENDING_BALANCE' => 'رصيد المنصة المعلّق غير كافٍ لإتمام العملية.',
    // AUTH
...
//    ],
    ...
    'ACCEPTED_REQUEST' =>'أهلاً بك، تم قبول طلب الاستشارة من قبل المستشار :name 😊 يرجى الدخول الآن إلى الجلسة، حيث يمكنك الاستفادة منها خلال 24 ساعة من وقت بدايتها.',
    ...
    // Phase 4 — Settlement
    'settlement_completed_patient'         => 'تمت تسوية الاستشارة رقم :consultation_id بنجاح مع :consultant. شكراً لاستخدامك المنصة.',
    'settlement_completed_consultant'      => 'تهانينا! أرباحك من الاستشارة رقم :consultation_id بقيمة :amount :currency أصبحت متاحة للسحب.',
    'review_window_expiring_patient'       => 'تنبيه: تبقّت ساعة واحدة لإغلاق نافذة النزاع على الاستشارة رقم :consultation_id. في حال حدث مشكلة خلال لاستشارة توجه لفتح نزاع   ،  في حال لم يتم فتح نزاع خلال ساعة ستتم تسوية المبلغ تلقائياً.',
