...
class CustomerController extends Controller
{
   use ResponseTrait;
    ...
    public function __construct(ICustomerRepositories $customerRepositories , ILocationRepositories $locationRepositories , ITherapistRepositories $therapistRepositories , IPatientRepositories $patientRepositories , IRehabilitationCenterRepositories $rehabilitationCenterRepositories)
   {
    ...
    public function getById($id): \Illuminate\Http\JsonResponse
   {
    ...
    {
        try {
            $searchServiceProviderService = new  SearchServiceProviderService();
            $results = $searchServiceProviderService->searchServiceProviders($request->all());
