...
class StoreConsultationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'confirmed_end_time'=>'',
            'consultation_price'       => ['nullable', 'numeric', 'min:0', 'max:9999.999', 'regex:/^\d{1,4}(\.\d{1,3})?$/'],
            'gateway_commission_rate'  => 'nullable|numeric|min:0|max:10',
            'gateway_commission_amount'=> 'nullable|numeric|min:0|max:999.9999',
            'net_amount'               => 'nullable|numeric|min:0|max:9999.999',
